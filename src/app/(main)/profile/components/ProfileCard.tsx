...
const ProfileCard = (
    {
        profileType, onProfileTypeChange,
    ...
    return (
        <div className="max-w-sm bg-white rounded-2xl shadow-md p-6 border border-gray-200">
            <div className="flex flex-col items-center">
                ...
                <span className="mt-2 px-4 py-1 text-sm bg-indigo-200 text-indigo-800 rounded-full font-medium"> Premium Provider </span>
                {profileType == "provider" &&
                    <ProviderContent isEditing={isEditing} onIsEditingChange={onIsEditingChange} subpage={subpage}
                                     onSubpageChange={onSubpageChange}/>
                }
                {profileType == "consumer" &&
                    <ConsumerContent isEditing={isEditing} onIsEditingChange={onIsEditingChange} subpage={subpage}
                                     onSubpageChange={onSubpageChange}/>
                }
            </div>
        </div>
