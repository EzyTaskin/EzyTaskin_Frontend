...
//       {/* Dropdown Buttons */}
//       <div className="mx-7 flex gap-10">
//         {["Categories", "Location", "Sort by"].map((label) => (
//           <button
//             key={label}
//             className="flex items-center px-4 py-2 rounded-lg shadow-sm bg-[#767680]/12 text-gray-700 font-medium hover:bg-gray-50 rounded-full"
//           >
//             {label}
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               className="h-4 w-4 ml-2 text-[var(--color-primary)]"
//               viewBox="0 0 20 20"
//               fill="currentColor"
//             >
//               <path
    ...
    <div className="flex items-center space-x-4 p-4 rounded-lg justify-center max-w-5xl ml-40">
      ...
      <div className="flex items-center bg-[#767680]/12 px-4 py-2 rounded-full shadow-sm w-2xs mx-20">
        ...
        <input
          ...
          value={searchQuery}
          onChange={onSearch}
          onKeyDown={onKeyPress} // Trigger the key press logic
          className="ml-2 bg-transparent focus:outline-none w-full text-gray-700"
        />
      </div>
