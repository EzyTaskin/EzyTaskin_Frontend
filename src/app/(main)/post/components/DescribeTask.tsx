                ...
                <div className="bg-white p-6 rounded-xl shadow-md border border-gray-200">
                    ...
                    <div className="mb-5">
                        ...
                        <input
                            ...
                            className="w-full border border-gray-300 rounded-md p-3 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500"
                        />
                    ...
                    <div className="mb-6">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                            {['Cleaning', 'Handyman', 'Moving', 'Delivery', 'Errands', 'Other'].map((category, index) => (
                                <label
                                    key={index}
                                    className="flex items-center justify-center p-3 border rounded-md text-sm font-medium cursor-pointer transition hover:border-purple-500"
                                >
                                    <input
                                        type="radio"
                                        name="category"
